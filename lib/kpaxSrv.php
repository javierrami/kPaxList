...
class kpaxSrv {
  ...
  public function addGame($campusSession, $obj) {
    ...
    */
    public function getCategories($type) {
        $listCategories = $this->service("/category/list?q={\"type\":\"".skill."\"}");
  ...
  public function getCategory($campusSession, $idCategory) {
    ...
    */
    /**
    *Obtiene los tipos de tag disponibles para su consulta. 
    * Tags: 
    *	Similar Games
    *	Skills
    *	Platforms
    *	
    * La mantenemos para no romper compatibilidades con versiones antiguas. 
    */
    public function getTags($tag) {
    	//directamente a getcategories
    	return getCategories($tag);
    	
    	if ($tag == "skills"){
    		return array ("muycomplicado","facil");
    	} else if ($tag == "platforms"){
    		return array ("android","unix");
    	} else if ($tag == "categories"){
    		return array ("categoria 1","categoria 2");
    	}
        return null;
    }
